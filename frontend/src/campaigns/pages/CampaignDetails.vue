  ...
  <gb-base-layout>
    ...
    <div class="campaignDetails-infoContainer is-padding-boxed">
      ...
      <div class="campaignDetails-infoContainer-data">
        ...
        <gb-campaign-info-row v-if="campaign.pitchUrl" id="pitchUrlSection" :title="$tc('message.Video')"> https://www.youtube.com/embed/kJ3sxh-bHJs
          <iframe v-if="campaign.pitchUrl.includes('youtube')" width="560" height="315" v-bind:src="'https://www.youtube.com/embed/' + campaign.pitchUrlsplit('?').slice(-1)[0].split('&').filter(param => param.includes('v=')).slice(-1)[0].split('v=').slice(-1)[0]" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
